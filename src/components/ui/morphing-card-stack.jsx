  ...
  return (
    <div className={cn("space-y-4", className)}>
      ...
      <LayoutGroup>
        ...
        <motion.div layout className={cn(containerStyles[layout])} style={layout === "stack" ? { width: 320, height: 280 } : undefined}>
            ...
            {displayCards.map((card) => {
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    "cursor-pointer rounded-xl bg-card p-4",
                    "transition-colors",
                  ...
                  style={{
                    ...
                    ...(layout === "stack" ? { width: 280, height: 240 } : {}),
                  }}
                >
